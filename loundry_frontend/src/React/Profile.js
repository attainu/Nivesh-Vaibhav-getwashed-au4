...
class Profile extends React.Component {
  ...
  UNSAFE_componentWillMount = () => {
    ...
    // let result = axios.get("http://localhost:8080/authenticate", {
      ...
      <div>
        <Jumbotron>
          <h1>
            ...
            Welcome To Express Loundry
          </h1>
          <p>
            <quote left="true" /> "Express Loundry are here To get take care of
            your cloth" <quote right="true" />
          </p>
